                ...
                <div class="col-sm-10">
                    <div class="btn-toolbar" style="margin:1em 0 1em -5px;" role="toolbar" onKeyPress="return checkSubmit(event)" aria-label="...">
                        <div class="btn-group" role="group" aria-label="...">
                            <button type="submit" id="action" name="action" value="password" class="btn btn-primary">Сброс пароля</button>
                            <a class="btn btn-success" href="./index.php">Авторизоваться</a>
                        </div>
                    </div> <!--button toolbar -->
