...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse subMenu">
  <div class="navbar-inner container-fluid container-fluid">
    <ul class="nav navbar-nav">
    	<li id="subMenuNew"><a href="./main.php">Новый</a></li>
	<li id="subMenuMine"><a href="./tickets.php?ticketId=mine">Мой запрос</a></li>
	<li id="subMenuAll"><a href="./tickets.php?ticketId=all">Все</a></li>
	<li id="subMenuOpen"><a href="./tickets.php?ticketId=open">Открыть</a></li>
	<li id="subMenuClient" ><a href="./tickets.php?ticketId=woc">Ожидание клиента</a></li>
	<li id="subMenuAgent" ><a href="./tickets.php?ticketId=woa">Ожидание агента</a></li>
	<li id="subMenuClosed"><a href="./tickets.php?ticketId=closed">Закрыть</a></li>
    </ul>
  </div>
</nav>
...
?>
				...
				<form class="form" method="POST" enctype="multipart/form-data">
					...
					<input type="text" name="previousAssignedUser" value="<?php echo '' . $ticket->getAssignedUser();?>" hidden />
			                <div class="form-group">
			                    <label for="ticketId" class="col-sm-2 control-label">Запросы# </label>
			                    <div class="col-sm-10">
			                ...
			                <div class="form-group">
			                    <label for="ClientId" class="col-sm-2 control-label">Клиент# </label>
			                    <div class="col-sm-10">
			                ...
			                <div class="form-group">
			                    <label for="user" class="col-sm-2 control-label">Создан:</label>
			                    <div class="col-sm-10">
			                ...
			                <div class="form-group">
			                    <label for="subCategory" class="col-sm-2 control-label">Подкатегория:</label>
			                    <div class="col-sm-10">
			                ...
			                <div class="form-group">
			                    <label for="ticketNote" class="col-sm-2 control-label">Добавить примечания:</label>
			                    <div class="col-sm-10">
 ...
 <?php if($_SESSION['usertype']=='Administrator'){ ?>
			                <div class="form-group">
			                    <label for="group" class="col-sm-2 control-label">Назначенная группа:</label>
			                    <div class="col-sm-10">
 ...
 <?php if($_SESSION['usertype']=='Administrator'){ ?>
			                			<div class="form-group">
												<label for="assignedUser" class="col-sm-2 control-label">Назначенный пользователь :</label>
												<div class="col-sm-10">
 ...
 <?php } ?>
											<div class="form-group">
												<label for="comments" class="col-sm-2 control-label">Загрузить </label>
													<div class="col-sm-10">
														<div class="input-group">
															<input type="text" class="form-control" readonly>
								                <label class="input-group-btn">
								                    <span class="btn btn-default">
								                        Просматривать ...<input id="fileToUpload" name="fileToUpload" type="file" style="display: none;" multiple>
								                    </span>
								                </label>
								            </div>
													</div>
											...
											<div class="form-group">
												 <label for="comments" class="col-sm-2 control-label">Вложения  </label>
												 <div class="col-sm-10"><?php $ticket->linkAttachments(); ?></div>
											</div>

											<div class="form-group row">
									      <div class="offset-sm-2 col-sm-10">
									        <button name="updateTicket" class="btn btn-primary" type="submit">Обновлять </button>
									      </div>
									    </div>
