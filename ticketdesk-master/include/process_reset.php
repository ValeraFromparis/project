  ...
  <div class="panel-heading"> Сброс пароля</div>
	<div class="panel-body">
		...
		<form action="process_reset.php" method="post" id="resetPasswordForm" >
	        ...
	        <div class="form-group">
	            <label class="col-sm-2 control-label">Повтор</label>
	            <div class="col-sm-10">
                ...
                <div class="col-sm-10">
                    <div class="btn-toolbar" style="margin:1em 0 1em -5px;" role="toolbar" aria-label="...">
                        <div class="btn-group" role="group" aria-label="...">
                            <button type="button" id="action" name="action" class="btn btn-primary" onclick="mypasswordmatch()">Представить</button>
                        </div>
                    </div> <!--button toolbar -->
