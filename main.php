...
?>
    ...
    <div id="newTicket" class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-horizontal" method="POST" action="#" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="comments" class="col-sm-2 control-label">Подробности</label>
                    <div class="col-sm-10">
                        <textarea class="form-control verticalonly" name="comments"></textarea>
                    </div>
                </div>

                <div class="btn-group">
                    <button type="submit" name="addTicket" class="btn btn-primary">Создать</button>
                    <button type="submit" name="addQuickTicket" class="btn btn-success">Создать & Закрыть</button>
                </div>
                <div class="btn-group">
    ...
    <div id="recentTickets" class="panel panel-default">
        <div class="panel-heading">Недавние запросы</div>
            <?php ticket::displayRecentTickets(); ?>

    </div>
<div id="totals" class="well welroundl-sm-2" >
Всего запросов: <?php echo ''. ticket::getTicketCount(); ?> <br>  Среднее за день: <?php echo ''. ticket::getDailyAverage(); ?>
</div>
