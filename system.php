...
<div id="content">
		<div id="displayCategories" class="panel panel-default">
				...
				<form class="form" method="post">
				    ...
				    <label for="version" class="col-sm-3 control-label">Версия системы</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				    <label for="authentication" class="col-sm-3 control-label">Аутентификация</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				    <label for="email" class="col-sm-3 control-label">Уведомление по электронной почте</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				    <label for="language" class="col-sm-3 control-label">Язык</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				 	 ...
				 	 <button class="btn btn-success" name="saveSettings" type="submit">Сохранить</button>
				      </div>
				  </div>
		...
		<div id="displayCategories" class="panel panel-default">
        		<div class="panel-heading">Категории</div>
		        	...
		        	<div class="panel-body">
						...
						<button type="submit" name="addCategory" class="btn btn-success">Добавить категорию</button>
					</form>
					<form class="form-inline" method="POST">
						<div class="form-group">
						...
						<button type="submit" name="addSubCategory" class="btn btn-success">Добавить подкатегорию</button>
					</form>
				</div>
			</div>
